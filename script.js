$(document).ready(function() {
  ...
  createCarousel(".ad-carousel" , ".ad-item");
  // create carousel for hot product
  createCarousel(".hot-product-carousel" , ".product-carousel-item");
});

function createCarousel(carousel_container, carousel_item) {
  // plan:
  ...
  $(carousel_container + " #next").click(function() {
    $(carousel_item + ":nth(0)").animate({
      ...
      $(carousel_container).append(current_slide); // then put it at the end
    });
  });
